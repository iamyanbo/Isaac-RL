param(
    ...
    [switch]$Resume,
    [string]$Initialize = '',
    [ValidateSet('', 'legacy_v1', 'balanced_v2', 'confirmed_v3', 'completion_v4', 'native_clear_v5')][string]$RewardProfile = '',
    [ValidateSet('', 'legacy_v1', 'terrain_v2', 'combat_history_v3', 'combat_gru_v4')][string]$ObservationProfile = '',
    [switch]$NoMonitor,
