...
from .rewards import GAMMA, PROFILES, door_potential


class IsaacEnv(gym.Env):
    metadata = {"render_modes": []}

    def __init__(self, bridge=None, frames=8, max_steps=3375, idle_limit=450, reward_profile="legacy_v1", observation_profile="legacy_v1"):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        return encode(self.state,self.cells,self.observation_profile), self._info()
    ...
    def step(self, action):
        ...
        components = {
            "time":cfg.time, "explore_cell":cfg.cell if count == 1 else 0,
            ...
            "navigation":GAMMA*door_potential(after,cfg.door_potential)-door_potential(before,cfg.door_potential),
        }
        ...
        return encode(after,self.cells,self.observation_profile),reward,terminated,truncated,info
